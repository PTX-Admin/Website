    ...
    inputs: [
      {
        ...
        internalType: 'struct PresaleAdminController.InitConfig',
        name: 'config',
        type: 'tuple',
      },
      {
